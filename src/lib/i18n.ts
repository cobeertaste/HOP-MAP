...
export const SPOT_DESCRIPTIONS_EN_BY_ID: Record<string, string> = {
  ...
  "brew-portugal-lisboa": "BREW Portugal is a craft beer embassy in Lisbon with 23 craft beer taps and artisan pizzas.",
  "brew-portugal": "BREW Portugal is a craft beer embassy in Lisbon with 23 craft beer taps and artisan pizzas.",
...
export const translations = {
  PT: {
    ...
    passwordsDoNotMatch: 'As palavras-passe não coincidem. O campo "Confirmar Palavra-Passe" tem de ser exatamente igual ao campo "Palavra-Passe".',
    passwordsMatch: 'Palavras-passe coincidem',
    confirmPasswordRequired: 'Por favor, confirma a tua palavra-passe.',
    ...
    // Referral System & Ambassador Badge
    inviteFriendBtn: 'Convidar Amigo',
    inviteFriendTitle: 'CONVIDAR AMIGO & GANHAR BADGE',
    inviteFriendSubtitle: 'Partilha o teu link único e ganha a medalha "Embaixador HOP MAP" quando o teu amigo fizer o 1.º check-in!',
    inviteLinkCopiedTitle: 'Link Copiado! 📋',
    inviteLinkCopiedMsg: 'O teu link de convite único foi copiado para a área de transferência.',
    inviteShareTitle: 'Convite HOP-MAP 🍻',
    inviteShareText: 'Junta-te a mim no HOP-MAP! Descobre os melhores taprooms e cervejarias artesanais de Portugal. Usa o meu link:',
    ambassadorBadgeUnlockedTitle: '🏆 Novo Badge: Embaixador HOP MAP!',
    ambassadorBadgeUnlockedMsg: 'O teu amigo completou o primeiro check-in! Parabéns, ganhaste a medalha de Embaixador HOP MAP!',
    referralLinkTooltip: 'Link único de recomendação',
    copyLinkBtn: 'Copiar Link',
    ambassadorBadgeName: 'Embaixador HOP MAP',
    ambassadorBadgeDesc: 'Ganha este badge quando um amigo convidado por ti fizer o primeiro check-in no HOP-MAP.',
    ambassadorBadgeStatusUnlocked: 'Medalha Desbloqueada! 🤝',
    ambassadorBadgeStatusPending: 'A aguardar primeiro check-in de amigo convidado',
    shareSocialTitle: 'Partilhar por Mensagem Direta ou Redes Sociais:',
    inviteLangSelectLabel: 'Idioma do convite:',
    inviteShareTextPT: 'Junta-te a mim no HOP-MAP! Descobre os melhores spots e bares de cerveja artesanal de Portugal. Usa o meu convite:',
    inviteShareTextEN: 'Join me on HOP-MAP! Discover the best craft beer taprooms and spots in Portugal. Use my invite link:',
    shareViaWhatsApp: 'WhatsApp',
    shareViaFacebook: 'Facebook / Messenger',
    shareViaInstagram: 'Instagram (Direct)',
    whatsappSharePrompt: 'Partilhar por WhatsApp',
    facebookSharePrompt: 'Mensagem no Messenger / Facebook',
    instagramSharePrompt: 'Mensagem Direta no Instagram',
    instagramCopiedNoticeTitle: 'Mensagem e Link Copiados! 📋',
    instagramCopiedNoticeMsg: 'Abre o Instagram Direct para colares a mensagem e convidares os teus amigos.',
    ...
    alreadyCheckedInToday: '⛔ Já fizeste check-in neste spot hoje! Volta amanhã.',
    gpsTooFar100m: 'Estás demasiado longe deste local para fazer check-in. Deves encontrar-te a menos de 100 metros do spot.',
    stageClear: 'STAGE CLEAR! 🍻',
    checkinSuccessCoin: '+1 HOP Conquistado! Check-in validado.',
    verifyingPin: 'A VALIDAR...',
    verifyingGps: 'A ler coordenadas GPS nativo (raio de 100m)...',
    antiFraudNotice: '🔒 Sistema anti-fraude: Apenas check-ins a menos de 100 metros do local acumulam pontos HOP.',
  ...
  EN: {
    ...
    confirmPasswordPlaceholder: '••••••••',
    passwordsDoNotMatch: 'Passwords do not match. The "Confirm Password" field must exactly match the "Password" field.',
    ...
    // Header Dropdown Menu & Help
    menuTitle: 'HOP-MAP Menu',
    menuProfile: 'Profile',
    menuHopChat: 'Community HOP-Chat',
    menuBuyBeer: 'Buy us a round',
    menuLeaderboard: 'View Leaderboard',
    ...
    inviteFriendTitle: 'INVITE FRIEND & EARN BADGE',
    inviteFriendSubtitle: 'Share your unique link and earn the "HOP MAP Ambassador" badge when your friend completes their 1st check-in!',
    inviteLinkCopiedTitle: 'Link Copied! 📋',
    inviteLinkCopiedMsg: 'Your unique invite link was copied to clipboard.',
    inviteShareTitle: 'Invite to HOP-MAP 🍻',
    inviteShareText: 'Join me on HOP-MAP! Discover the best craft beer taprooms and breweries in Portugal. Use my link:',
    ambassadorBadgeUnlockedTitle: '🏆 New Badge: HOP MAP Ambassador!',
    ambassadorBadgeUnlockedMsg: 'Your friend completed their first check-in! Congratulations, you earned the HOP MAP Ambassador badge!',
    referralLinkTooltip: 'Unique referral link',
    copyLinkBtn: 'Copy Link',
    ambassadorBadgeName: 'HOP MAP Ambassador',
    ambassadorBadgeDesc: 'Earn this badge when a friend you invited completes their first check-in on HOP-MAP.',
    ambassadorBadgeStatusUnlocked: 'Badge Unlocked! 🤝',
    ambassadorBadgeStatusPending: 'Waiting for invited friend’s first check-in',
    shareSocialTitle: 'Share via Direct Message or Social Networks:',
    inviteLangSelectLabel: 'Invite language:',
    inviteShareTextPT: 'Junta-te a mim no HOP-MAP! Descobre os melhores spots e bares de cerveja artesanal de Portugal. Usa o meu convite:',
    inviteShareTextEN: 'Join me on HOP-MAP! Discover the best craft beer taprooms and spots in Portugal. Use my invite link:',
    shareViaWhatsApp: 'WhatsApp',
    shareViaFacebook: 'Facebook / Messenger',
    shareViaInstagram: 'Instagram (Direct)',
    whatsappSharePrompt: 'Share via WhatsApp',
    facebookSharePrompt: 'Message on Messenger / Facebook',
    instagramSharePrompt: 'Direct Message on Instagram',
    instagramCopiedNoticeTitle: 'Message & Link Copied! 📋',
    instagramCopiedNoticeMsg: 'Open Instagram Direct to paste the message and invite your friends.',
    ...
    alreadyCheckedInToday: '⛔ You have already checked in at this spot today! Come back tomorrow.',
    gpsTooFar100m: 'You are too far from this location to check in. You must be within 100 meters of the spot.',
    stageClear: 'STAGE CLEAR! 🍻',
    checkinSuccessCoin: '+1 HOP Earned! Check-in validated.',
    verifyingPin: 'VERIFYING...',
    verifyingGps: 'Reading native GPS coordinates (100m radius)...',
    antiFraudNotice: '🔒 Anti-fraud system: Only check-ins within 100 meters of the spot earn HOP points.',
